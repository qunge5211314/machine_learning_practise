...
print("sum:\n", a.sum())  # 对ndarray对象中所有元素求和
print("min:\n",a.min())  # 找出ndarray对象中所有元素中的最小值并返回
print("max:\n",a.max())  # 找出ndarray对象中所有元素中的最大值并返回
print("mean:\n",a.mean())  # 求ndarray对象中所有元素的均值
print("var:\n",a.var())  # 求ndarray对象的中所有元素的方差
print("std:\n",a.std())  # 求ndarray对象的中所有元素的标准差
